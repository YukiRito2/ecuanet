    ...
    <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Agenda Tu Diagnóstico Gratuito</h2>
              <p className="text-xl text-gray-600">Sin compromiso. En 24 horas te decimos exactamente qué podemos hacer por tu operación.</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Propuesta en 24 horas</p>
                </div>
              </motion.a>
              ...
              <motion.div whileHover={{ x: 5 }} className="flex items-center gap-3 p-4 rounded-lg border border-gray-200 hover:border-red-400 hover:bg-red-50 transition-all">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Andorra, La Vella</p>
                </div>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            <div className="p-12 bg-gradient-to-br from-blue-50 to-yellow-50 rounded-2xl border border-gray-200">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">¿Por qué esperar?</h3>
              <ul className="space-y-3 mb-8">
                {['Sin compromiso', 'Presupuesto personalizado', 'Respuesta en 24 horas', 'Equipo profesional'].map((item, i) => (
